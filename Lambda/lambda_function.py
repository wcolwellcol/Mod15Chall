...
def validate_data(age, investment_amount, intent_request):
    ...
    if age is not None:
        ...
        if int(age) >= 65:
            return build_validation_result(False,
        'age',
        'You should be no older than 64 years old to use this service, '
        'please provide a different age.')
    
    #Validate investment amount, it should be > 5000
    if investment_amount is not None:
        if int(investment_amount) < 5000:
            return build_validation_result(False,
            'investmentAmount',
            'The amount to allocate should be at least 5000, '
